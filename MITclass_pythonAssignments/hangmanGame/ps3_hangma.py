...
WORDLIST_FILENAME = "c:\users\ecazacu\dropbox\onlinelearning\pythonclass\mitx6.00\week3\hw\hangman\words.txt"
...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    while not gameOver:
        ...
        letterRemaining=getAvailableLetters(lettersGuessed)
        print('Available letters: '+letterRemaining)
